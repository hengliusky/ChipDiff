...
from util_hed.hed import estimate
...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        print('self.model_var_type' , model_var_type)
    ...
    def condition_score(self, cond_fn, p_mean_var, x, t, model_kwargs=None):
        ...
        gradient,flag = cond_fn(x, self._scale_timesteps(t), **model_kwargs)#需要实际的图片
    ...
    def p_sample(
        ...
        return {"sample": sample, "pred_xstart": out["pred_xstart"],"flag":flag, "plain_xt": out["plain_xt"]}
    ...
    def p_sample_loop_progressive(
        ...
        while count_time< max_time:#最多重启采样20次
            count_time += 1
            if flag:
                indices = list(range(self.num_timesteps - skip_timesteps))[::-1]
                indices = tqdm(indices)
            ...
            for i in indices:
                ...
                if flag:
                    img = th.randn(*shape, device=device)#原本的
                ...
                if i == self.num_timesteps-skip_timesteps-1:
                    ...
                    with th.no_grad():
                        ...
                        out_list.append(out["pred_xstart"])
                        out_xt_list.append(img)
    ...
    def ddim_sample(
        ...
        return {"sample": sample, "pred_xstart": out["pred_xstart"], "flag":flag}#pred_xstart 是最终的输出图片， sample是去噪迭代的中间过程
