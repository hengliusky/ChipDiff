...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "-tg_dir", "--target_image_dir", type=str, help="The dir of  target style images", required=False
    )
    ...
    parser.add_argument(
        "--style_step",
        type=int,
        help="How many steps to use style loss during the diffusion.",
        default=40,
    )
    ...
    parser.add_argument("--diff_iter", type=int, help="The number of augmentation", default=100)
    ...
    parser.add_argument(
        "--l2_hist",
        type=float,
        help="l2 loss for hist color loss",
        default=1.0,
    )
    parser.add_argument(
        "--range_lambda",
    ...
    parser.add_argument(
        "--lambda_hed", type=float, help="hed loss", default=10000,
    )
    ...
    parser.add_argument(
        "--lambda_ssim", type=float, help="key self similarity loss", default=1500,
    )
    parser.add_argument(
        "--lambda_dir_cls", type=float, help="semantic divergence loss", default=100,
    )
    parser.add_argument(
        "--hed_strength", type=float, help="hed strength in init", default=0.8,
    )
