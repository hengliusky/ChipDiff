...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        hed_out = estimate(init_image).repeat(1, 3, 1, 1)
        hed_out = hed_out * 2 - 1
        ...
        init_image_batch = init_image_batch + hed_out * 0.8  # 0.8
        ...
        last_resample_time = 3

        while count_time < max_time:
            count_time += 1
            if flag:
                indices = list(range(self.num_timesteps - skip_timesteps))[::-1]
                indices = tqdm(indices)
            ...
            for i in indices:
                # if i == 20 :
                #     for t in range(last_resample_time):
